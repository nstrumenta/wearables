...
(function(undefined) {
    if (google.maps.Polyline.prototype.edit === undefined) {
        function start(polyline, options) {
            ...
            if (options.ghosts) {
                var imgGhostVertex = new google.maps.MarkerImage(options.imagePath + 'ghostVertex.png',new google.maps.Size(11,11),new google.maps.Point(0,0),new google.maps.Point(6,6));

                var imgGhostVertexOver = new google.maps.MarkerImage(options.imagePath + 'ghostVertexOver.png',new google.maps.Size(11,11),new google.maps.Point(0,0),new google.maps.Point(6,6));
                ...
                function vertexGhostDrag() {
                    if (ghostPath.getPath().getLength() === 0) {
                        ghostPath.setPath([this.marker.getPosition(), this.getPosition(), at(this.marker.editIndex + 1)]);
                    }
                ...
                function vertexGhostDragEnd() {
                    var position = this.getPosition(), index = this.marker.editIndex + 1, vertex;
                ...
                function createGhostMarkerVertex(point) {
                    if (point.marker.editIndex < polyline.getPath().getLength() - 1) {
                        var next = at(point.marker.editIndex + 1), position, vertex;
            ...
            var imgVertex = new google.maps.MarkerImage(options.imagePath + 'vertex.png',new google.maps.Size(11,11),new google.maps.Point(0,0),new google.maps.Point(6,6));

            var imgVertexOver = new google.maps.MarkerImage(options.imagePath + 'vertexOver.png',new google.maps.Size(11,11),new google.maps.Point(0,0),new google.maps.Point(6,6));

            function vertexMouseOver() {                    
                google.maps.event.trigger(polyline, 'mouseover_at', this.editIndex, this.getPosition());
            ...
            function vertexDrag() {
                ...
                google.maps.event.trigger(polyline, 'drag_at', this.editIndex, this.getPosition());
                vertex.marker = this;
            ...
            function vertexDragEnd() {
                google.maps.event.trigger(polyline, 'update_at', this.editIndex, this.getPosition());
            }
                
            
            function vertexDblClick() {
                google.maps.event.trigger(polyline, 'dblclick_at', this.editIndex, this.getPosition());
            }

            function vertexRightClick() {
                google.maps.event.trigger(polyline, 'rightclick_at', this.editIndex, this.getPosition());
                if (!options.ghosts) {
                    return;
                }
            ...
            function createMarkerVertex(point) {
                ...
                if (!vertex) {
                    ...
                    google.maps.event.addListener(vertex, "dblclick", vertexDblClick);
